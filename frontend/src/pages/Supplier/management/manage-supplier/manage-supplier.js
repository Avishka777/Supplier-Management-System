      ...
      <div className="actionbar-container-manage-inventory">
        ...
        <div className="search-results-section">
          ...
          <div className="inventory-info-item-head">
            <span className="item-field-head-manage-inventory">Company</span>
            <span className="item-field-head-manage-inventory">Agent Name</span>
            <span className="item-field-head-manage-inventory">Agent ID</span>
            <span className="item-field-head-manage-inventory">Brand</span>
